...
public class GetAllNonMarkedCompaniesCommand implements Command {

    private Connection connection;

    public GetAllNonMarkedCompaniesCommand(Connection connection) {
        this.connection = connection;
    }

    @Override
    public Message execute(Message request) {
        request.setCommand(Commands.GET_ALL_NON_MARKED_COMPANIES);
